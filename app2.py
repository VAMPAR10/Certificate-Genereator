...
def generate_certificate():
    ...
    if equipment_tested == equipment_tested_choices[3]:
        template_ctpt = cv2.imread('ct pt.jpg')
    else:
        template_ctpt = cv2.imread('CT.jpg')
    ...
    if st.button("Generate Certificate"):
        ...
        i = 1
        while os.path.exists(f'C:\\Users\\DEV\\OneDrive\\Desktop\\Nmolds\\generated certificate\\{i}.pdf'):
            i += 1
        cv2.imwrite(f'C:\\Users\\DEV\\OneDrive\\Desktop\\Nmolds\\generated certificate\\{i}.jpg', template_ctpt)
        with open(f'C:\\Users\\DEV\\OneDrive\\Desktop\\Nmolds\\generated certificate\\{i}.jpg', "rb") as f:
            jpg_data = f.read()

        with open(f'C:\\Users\\DEV\\OneDrive\\Desktop\\Nmolds\\generated certificate\\{i}.pdf', "wb") as f:
            f.write(img2pdf.convert(jpg_data))
        os.remove(f'C:\\Users\\DEV\\OneDrive\\Desktop\\Nmolds\\generated certificate\\{i}.jpg')    
